...
*/
	...
	public String getID_dep_Sup() {
		return this.ID_dep_Sup;
	}

	public void setID_dep_Sup(String ID_dep_Sup) {
		this.ID_dep_Sup = ID_dep_Sup;
	}

	public String getMle_Chef_Dep() {
		return this.mle_Chef_Dep;
	}

	public void setMle_Chef_Dep(String mle_Chef_Dep) {
		this.mle_Chef_Dep = mle_Chef_Dep;
	}
