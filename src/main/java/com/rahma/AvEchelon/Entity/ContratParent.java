...
public class ContratParent  {
	...
	public Date getDate_Entree_Etab() {
		return this.date_Entree_Etab;
	}

	public void setDate_Entree_Etab(Date date_Entree_Etab) {
		this.date_Entree_Etab = date_Entree_Etab;
	}
	...
	public List<ContratDetail> getTContratDetails() {
		return this.TContratDetails;
	}

	public void setTContratDetails(List<ContratDetail> TContratDetails) {
		this.TContratDetails = TContratDetails;
	}

	public Personnel getPersonnelContratParent() {
		return personnelContratParent;
	}

	public void setPersonnelContratParent(Personnel personnelContratParent) {
		this.personnelContratParent = personnelContratParent;
	}
