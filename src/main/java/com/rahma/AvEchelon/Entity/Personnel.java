...
public class Personnel{
	...
	public Date getDate_Anc() {
		return this.date_Anc;
	}

	public void setDate_Anc(Date date_Anc) {
		this.date_Anc = date_Anc;
	}
	...
	public Date getDate_Entre_Etab() {
		return this.date_Entre_Etab;
	}

	public void setDate_Entre_Etab(Date date_Entre_Etab) {
		this.date_Entre_Etab = date_Entre_Etab;
	}
	...
	public Date getDate_Sortie_Etab() {
		return this.date_Sortie_Etab;
	}

	public void setDate_Sortie_Etab(Date date_Sortie_Etab) {
		this.date_Sortie_Etab = date_Sortie_Etab;
	}
	...
	public String getMotif_Sortie() {
		return this.motif_Sortie;
	}

	public void setMotif_Sortie(String motif_Sortie) {
	...
	public List<Poste> getTPostes() {
		return TPostes;
	}


	public List<Avancement> getTAvancements() {
		return TAvancements;
	}


	public void setTAvancements(List<Avancement> tAvancements) {
		TAvancements = tAvancements;
	}
	...
	public void setTPostes(List<Poste> tPostes) {
		TPostes = tPostes;
	}
