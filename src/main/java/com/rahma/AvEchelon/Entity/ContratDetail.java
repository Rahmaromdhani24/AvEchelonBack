...
public class ContratDetail  {
	...
	public String getCDD_File() {
		return this.CDD_File;
	}

	public void setCDD_File(String CDD_File) {
		this.CDD_File = CDD_File;
	}
	...
	public ContratParent getDetailsContratParent() {
		return detailsContratParent;
	}

	public void setDetailsContratParent(ContratParent detailsContratParent) {
		this.detailsContratParent = detailsContratParent;
	}
